ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :blogs, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :videos, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :statuses, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :comments, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :events, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :guilds, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :polls, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :sharings, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :tags, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
    
    admin.resources :photo_tags, :member => {:verify => :put, :unverify => :put }, :collection => {:search => :get}
